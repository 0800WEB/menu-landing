    ...
    return (
        <div id="section-menu" className="h-screen md:h-screen flex flex-col relative ">
            <div className="flex flex-col-reverse justify-end md:justify-start md:flex-row h-full [&>div]:md:w-1/2 md:pt-24 md:gap-12">
                <div className="w-full h-[50%] md:h-full relative mx-auto flex ">
                ...
                <div className="flex flex-col gap-5 pt-7 [&_p]:text-pretty [&_p]:leading-5 md:[&_p]:leading-8 [&_p]:tracking-custom-3p [&_p]:text-xs [&_p]:sm:text-base [&_p]:lg:text-lg [&_p]:xl:text-xl">
                    <h2 className="font-extrabold tracking-custom-3p text-2xl sm:text-4xl md:text-[2.5rem] lg:text-5xl xl:text-6xl leading-9 md:leading-[3.125rem] lg:leading-[4.25rem]">TU MENÚ SIEMPRE <br /><span className="text-highlight">A LA MANO</span></h2>
