...
const SectionHero = () => {
    return (
        <div className="h-max md:h-screen flex flex-col relative gap-10 md:gap-0 [&_p]:text-pretty [&_p]:leading-[19px] md:[&_p]:leading-8 [&_p]:tracking-custom-3p [&_p]:text-xs [&_p]:sm:text-base [&_p]:md:text-lg [&_p]:lg:text-lg [&_p]:xl:text-xl lg:[&_h2]:leading-[3rem] [&_h2]:tracking-custom-3p">
